...
<div id="page" class="shell">
  ...
  <div id="header">
	...
	<div class="gcontent" align="center">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<p align="center">FIFA 17</p>
		<br><br>
		<img src="images/fifa17.jpg" height="400px" width="700px">
		<br><br>
		...
		Commentary is once again provided by Martin Tyler and Alan Smith (play-by-play / analysis), Alan Mcanally (in-game score updates), Jeff Shreaves (injury reports), and Mike West (classified results for major leagues). Commentary in other languages (such as Spanish and French) is also provided
		</div>
	</div>
...
$sql = "select username,text from comments where Gameid = 2 ";
