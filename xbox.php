...
<div id="page" class="shell">
      ...
      <div class="bg-right">
        <div class="bg-left">
          ...
          <ul>
            ...
            <li  class="first active"><a href="xbox.php">XBOX </a><span class="sep">&nbsp;</span></li>
  ...
  <?php
	...
	$sql = "select imglink,Gname,des from games where Genre=\"XBOX\";";
	...
	print("<div class=\"block\" >
			<div class=\"img\">
			<a href=\"$row[0].php\">
			<img src=\"$row[0].jpg\" height=\"280px\" width=\"500px\"></a>
			</div>
	
			<div class=\"des\">
			<h1 align=\"center\">$row[1] </h1> <br><br>
			$row[2]
			</div>
		</div>");
	}
